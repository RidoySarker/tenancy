...
<head>
    ...
    <base href="https://cdn.jsdelivr.net/gh/linuxguist/bizpage@main/">
                ...
                <div class="col-xl-11 d-flex align-items-center justify-content-between">
                    ...
                    <nav id="navbar" class="navbar">
                        <ul>
                            ...
                            @if (Route::has('login'))
                            @auth
                            <li><a class="nav-link  " href="{{ route('dash') }}">Dashboard</a></li>
                            @else
                            <li><a class="nav-link  " href="{{ route('loginpage') }}">Log in</a></li>
                            @if (Route::has('register'))
                            <li><a class="nav-link  " href="{{ route('registerpage') }}">Register</a></li>
                            @endif
                            @endauth
                            @endif
        ...
        <div class="hero-container">
            <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/10.jpg)">
                        <div class="carousel-container">
                            <div class="container">
