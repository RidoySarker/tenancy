...
Route::middleware([
    ...
    Route::get('/app/dashboard', [HomeController::class, 'dash'])->middleware(['tenant.auth', 'verified'])->name('dash');
    ...
    Route::get('/profile', [HomeController::class, 'profile'])->middleware(['tenant.auth', 'verified'])->name('profile.tenant');
    ...
    Route::get('/admin/edit/user/{id}', [AdminController::class, 'index'])->middleware(['tenant.auth', 'verified'])->name('admin.edit.user');
    Route::post('/admin/user/edit', [AdminController::class, 'edit'])->middleware(['tenant.auth', 'verified'])->name('admin.user.edit');
    Route::get('/admin/user/{id}/reset', [AdminController::class, 'reset'])->middleware(['tenant.auth', 'verified'])->name('admin.reset.user');
    Route::get('/admin/user/{id}/delete', [AdminController::class, 'delete'])->middleware(['tenant.auth', 'verified'])->name('admin.delete.user');
